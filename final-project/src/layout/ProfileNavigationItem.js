...
export const ProfileNavigationItem = ({ currentLink, setCurrentLink }) => {

    const navigate = useNavigate();
    const condition = currentLink === '/profile';
    ...
    return <Box onClick={onProfileClicked} sx={{
        ...
        onMouseLeave={() => setColor(currentLink === '/profile' ? 'var(--primary)' : 'var(--light-text)')}>
        ...
        {currentLink === '/profile' && <span style={{ fontSize: '12px', fontWeight: 500 }}>Profile</span>}
    </Box>
}